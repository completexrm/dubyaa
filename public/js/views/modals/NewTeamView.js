define(['underscore', 'backbone', 'moment', 'jqueryui', 'bootstrap'], function(_, Backbone, moment){
  ...
  var NewTeamView = Backbone.View.extend({
    events: {
      'click #saveTeam' : 'doNewTeam',
    ...
    initialize : function() {
      ...
      this.$modal = this.$el.find('#newTeam');
    ...
    doNewTeam : function(event) {
      ...
      if(this.validateForm()) {
        ...
        $.post(this.wsURL + '/Team/Create', d, function(data) {
